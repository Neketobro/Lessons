...
function modalWindow(content) {
  ...
  const divModal = $('<div>').addClass('modal fade').attr('id', 'dynamicModal').attr('tabindex', '-1').attr('aria-hidden', 'true');
  ...
  const closeFooterButton = $('<button>').addClass('btn btn-secondary').attr('type', 'button').attr('data-bs-dismiss', 'modal').text('Закрити');
